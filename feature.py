...
#     ]   
#     with open("features_output_1.csv", mode="w", newline="") as file:
#         writer = csv.writer(file)
#         writer.writerow(["URL"] + feature_names)  # Write header
...
#                 try:
#                     result = future.result(timeout=10)  # Enforce 10-second timeout per URL
#                     writer.writerow(result)
#                     print(f"{result[0]} has been processed")
#                 except concurrent.futures.TimeoutError:
#                     print(f"Skipping {future_to_url[future]} due to timeout")
#                     writer.writerow([future_to_url[future]] + ["Timeout"] * 29)  # Handle timeout case
#                 except Exception as e:
#                     print(f"Error processing {future_to_url[future]}: {e}")
#                     writer.writerow([future_to_url[future]] + ["Error"] * 29)

#     print("CSV file 'features_output_1.csv' created successfully.")